...
class OwnerCommentNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'title' => 'Tanggapan Baru dari Owner',
            'message' => "{$userName} memberikan tanggapan pada laporan mingguan proyek {$projectName}.",
            'action_url' => route('projects.weekly-reports.show', [
                'project' => $this->comment->commentable->project_id,
