<x-app-layout>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="bg-gray-50 dark:bg-dark-700">
                                    <td colspan="4"
                                        ...
                                        Total Estimasi</td>
                                    <td class="px-3 py-1.5 text-sm font-bold text-gray-900 dark:text-white text-right">
    ...
    <!-- Approve PR Modal -->
    <x-confirm-modal id="approvePRModal" title="Setujui Purchase Request"
        message="Apakah Anda yakin ingin menyetujui Purchase Request ini untuk Level {{ $pr->current_approval_level }}?" 
        confirmColor="green" icon="check">
        <x-slot name="body">
            <form id="approvePRForm" action="{{ route('projects.pr.status', [$project, $pr]) }}" method="POST">
                @csrf
        ...
        <x-slot name="footer">
            <button type="submit" form="approvePRForm"
    ...
    <!-- Reject PR Modal -->
    <x-confirm-modal id="rejectPRModal" title="Tolak Purchase Request"
        message="Harap masukkan alasan penolakan untuk Purchase Request ini." 
        confirmColor="red" icon="x-mark">
        <x-slot name="body">
            <form id="rejectPRForm" action="{{ route('projects.pr.status', [$project, $pr]) }}" method="POST">
                @csrf
        ...
        <x-slot name="footer">
            <button type="submit" form="rejectPRForm"
