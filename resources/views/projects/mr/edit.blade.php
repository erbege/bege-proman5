<x-app-layout>
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-dark-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('projects.mr.update', [$project, $mr]) }}" method="POST" x-data="mrForm()">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <x-text-input id="request_date" name="request_date" type="date"
                                    class="mt-1 block w-full" :value="old('request_date', $mr->request_date->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes"
                                    ...
                                    rows="1">{{ old('notes', $mr->notes) }}</textarea>
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <x-primary-button>Update Material Request</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    @php
        $itemsData = $mr->items->map(function ($item) {
            return [
