<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Buat Weekly Report - {{ $project->name }}
        </h2>
    </x-slot>
                ...
                <form action="{{ route('projects.weekly-reports.store', $project) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="cover_title" value="{{ old('cover_title', 'Weekly Progress Report - Week ' . $nextWeek) }}"
                                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-dark-700 dark:text-white focus:ring-primary-500 focus:border-primary-500"
                        ...
                        <div>
                            ...
                            <textarea name="activities" rows="4"
                                class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-dark-700 dark:text-white focus:ring-primary-500 focus:border-primary-500"
                                placeholder="Deskripsi aktivitas yang dilakukan pada minggu ini...">{{ old('activities') }}</textarea>
                        </div>
