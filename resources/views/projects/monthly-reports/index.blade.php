    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <form action="{{ route('projects.monthly-reports.auto-generate-all', $project) }}" method="POST"
                    class="inline">
                    @csrf
                    <button type="submit"
                ...
                <!-- Create New -->
                @can('monthly_report.manage')
                <a href="{{ route('projects.monthly-reports.create', $project) }}"
    ...
    <div class="py-4">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <span class="text-sm text-blue-700 dark:text-blue-300">
                        Bulan saat ini: <strong>{{ \Carbon\Carbon::parse($currentDate)->translatedFormat('F Y') }}</strong> |
                        Monthly report berikutnya: <strong>{{ \Carbon\Carbon::createFromDate($nextPeriod['year'], $nextPeriod['month'], 1)->translatedFormat('F Y') }}</strong>
                    </span>
                </div>
            </div>
            ...
            <div x-data="{ showDeleteModal: false }">
                <form id="bulk-delete-form" action="{{ route('projects.monthly-reports.bulk-destroy', $project) }}"
                    method="POST">
                    @csrf
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-dark-700">
                                            ...
                                            <td class="px-3 py-1.5 whitespace-nowrap">
                                                <span
                                                    ...
                                                    {{ \Carbon\Carbon::createFromDate($report->year, $report->month, 1)->translatedFormat('M') }}
                                                </span>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="px-3 py-1.5 text-center text-gray-500 dark:text-gray-400">
                                                ...
                                                <p class="mt-2">Belum ada monthly report.</p>
                                                @can('monthly_report.manage')
                                                <a href="{{ route('projects.monthly-reports.create', $project) }}"
                                        ...
                                        <div class="sm:flex sm:items-start">
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">
                                                    Hapus Monthly Report</h3>
                                                <div class="mt-2">
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                                        Apakah Anda yakin ingin menghapus <strong
                                                            id="modal-selected-count">0</strong> monthly report yang
                                                        dipilih?
                                                    </p>
